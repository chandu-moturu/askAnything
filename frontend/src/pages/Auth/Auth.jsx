  ...
  return (
    <section className = "auth-section" >
        ...
        <div className = "auth-container-2">
              ...
              {!isSignup && <img src =  "" alt = 'spider' className = 'login-logo'/>}
              <form onSubmit = { handleSubmit }>
                ...
                }
                {
                   ( !isPhone||isSignup) &&(
                    ...
                    {
                      !isSignup &&(
                        <button type='button' className='handle-switch-btn' onClick={handlePhoneSwitch}>{isPhone ? "log in with email":"Login with phone"}</button>
                      )
                    }
